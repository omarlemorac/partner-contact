...
class res_partner(orm.Model):
    ...
    _columns = {
        ...
        'weight':fields.char('Weight', 30, help='Weight, please specify unit'),
        'height':fields.char('Height', 30, help='Height, please specify unit'),
        'shoe_size':fields.char('Shoe size', 20,
            help='Shoe size, please specify US, UK, other'),
        'dietary_requirements':fields.html('Dietary requirements',
           help='Dietary requirements'),
        'emergency_contact':fields.html('Emergency contact',
